...
class SubmitReset extends React.Component {
  ...
  initSockets() {
    Socket.on('codeFailure', () => {alert("Wrong code!")});
    Socket.on('codeSuccess', () => {this.props.navigation.navigate('UpdatePassword', {email: this.state.email})});
  }
      ...
      <SafeAreaView style = {styleSheets.MainContainer}>
        <QuestionButton/>
          ...
          <View style = {styles.LoginContainer}>
              ...
              <TouchableOpacity style = {styleSheets.PinkButton} onPress= {() => this.handleSubmit(this.state.code, this.state.email)}>
